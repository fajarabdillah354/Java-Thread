...
public class AtomicTest {
    ...
    //atomic digunakan untuk mengatasi masalah race condition nanum hanya diperuntukan bagi yang simple, contoh 1 variable yang butuh tidak boleh race condition
